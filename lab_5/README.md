...
1.  Точки доступа Определить небезопасные точки доступа (без шифрования
    – OPN)
...
1.  Данные клиентов Определить производителя для каждого обнаруженного
    устройства
...
В результате работы были импортированы данные из csv-файла и выполнены
задания

## Вывод

Были проанализированы датасеты с использованием tidyverse, а также
улучшены навыки использования библиотек dplyr, read.

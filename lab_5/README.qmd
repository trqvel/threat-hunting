...
В результате работы были импортированы данные из csv-файла и выполнены задания

## Вывод

Были проанализированы датасеты с использованием tidyverse, а также улучшены навыки использования библиотек dplyr, read.